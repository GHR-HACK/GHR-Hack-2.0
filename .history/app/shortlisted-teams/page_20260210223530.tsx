      ...
      <div className="px-4 py-10 mt-20">
        <Container>
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-8 max-w-8xl mx-auto rounded-full">
              ...
              <Input
                ...
                className="bg-white text-slate-900 border-slate-300 rounded-full"
                value={query}
                          ...
                          <div className="space-y-3 border-t border-black/10 pt-4">
                            <div className="flex gap-2">
                              <div className="w-20 flex-shrink-0">
                                <span className="text-xs font-red-hat-display font-semibold text-slate-500 uppercase leading-relaxed">
                                  College
                                </span>
                              </div>
                              <p className="text-sm font-red-hat-display text-black/80 flex-1 break-words leading-relaxed">
                                {team.college}
                              </p>
                            </div>
                          </div>
