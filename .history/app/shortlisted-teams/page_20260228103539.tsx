        ...
        <Container>
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-6 max-w-full">
              ...
              <Input
                id="team-search"
                placeholder="Search by team name, member or college"
            ...
            {hasTeams ? (
              <>
                {filteredTeams.length > 0 ? (
                  ...
                  <div className="w-full overflow-x-auto overflow-y-hidden rounded-2xl border border-black/10 shadow-sm">
                      ...
                      <tbody>
                        {filteredTeams.map((team, index) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-4">
                              {team.githubRepo ? (
                                <a href={team.githubRepo} target="_blank" rel="noopener noreferrer" className="text-primary-orange hover:underline">
                                  View Repo
                                </a>
                              ) : (
                  ...
                  /* No results */
                  <div className="w-full text-center rounded-2xl border border-black/10 p-12">
                    ...
                    <p className="text-slate-600 font-red-hat-display text-sm">
                      Try searching with a different team name, member or college
                    </p>
                  </div>
                )}
              </>
