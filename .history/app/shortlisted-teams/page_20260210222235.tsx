                        ...
                        <div className="p-6">
                          <div className="mb-4">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-orange to-primary-pink flex items-center justify-center text-white font-bold text-sm">
                                {index + 1}
                              </div>
                            </div>
                          ...
                          <div className="space-y-3 border-t border-black/10 pt-4">
                            <div className="flex items-start">
                              ...
                              <p className="text-sm font-red-hat-display text-black/80 flex-1">
                                {team.college}
                              </p>
                            </div>
                            ...
                            <div className="flex items-start">
                              ...
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-red-hat-display font-semibold bg-gradient-to-r from-primary-orange/10 to-primary-pink/10 text-primary-orange">
                                {team.track}
                              </span>
                            </div>
                          </div>
