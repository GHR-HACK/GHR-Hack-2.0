          ...
          {hasTeams ? (
            <>
              {filteredTeams.length > 0 ? (
                    ...
                    <TableBody>
                      {filteredTeams.map((team) => (
                        <TableRow key={team.teamName}>
                          ...
                          <TableCell className="whitespace-nowrap">{team.college}</TableCell>
                ...
                <div className="rounded-xl border border-slate-200 bg-white shadow-sm px-6 py-10 text-center text-slate-600">
                  No results found.
                </div>
              )}
            </>
