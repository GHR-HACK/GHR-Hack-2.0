                        ...
                        {filteredTeams.map((team, index) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-4">
                              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-primary-orange to-primary-purple flex items-center justify-center text-white font-bold text-xs">
                                {index + 1}
                              </div>
                            </td>
