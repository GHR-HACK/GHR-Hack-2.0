...
export default function Mentors() {
  ...
  const renderProfileCard = (mentor: any, index: number = 0) => (
    <Card
      ...
      variant="elevated"
      hover
      className={`mentor-card group relative h-96 max-w-sm`}
    >
      <div className="w-full h-full rounded-3xl overflow-hidden">
        <div className="w-full h-full bg-gradient-to-b from-primary-orange/30 to-primary-purple/30 flex flex-col items-center justify-center p-8 text-center">
