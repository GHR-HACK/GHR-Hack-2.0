              ...
              {organizers.coordinators.map((coordinator, index) => (
                ...
                >
                  <div className="p-6 text-center">
                    ...
                    <h4 className="text-lg font-red-hat-display font-bold text-gray-800 mb-2 group-hover:gradient-text transition-all duration-300">
                      {coordinator.name}
                    </h4>
                ...
                {(organizers[role.key as keyof typeof organizers] as string[]).map((member: string, index: number) => (
                  ...
                  >
                    <div className="p-4 text-center">
                      ...
                      <h5 className="text-sm font-red-hat-display font-bold text-gray-600 group-hover:gradient-text transition-all duration-300">
                        {member}
                      </h5>
                    </div>
                  </Card>
