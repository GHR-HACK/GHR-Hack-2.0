...
export default function Organizers() {
  ...
  useEffect(() => {
    ...
    mm.add({ isDesktop: '(min-width: 768px)' }, (context) => {
      const cards = sectionRef.current?.querySelectorAll('.organizer-card')
      ...
      return gsap.from(cards, {
        ...
        y: context.conditions.isDesktop ? 34 : 20,
        opacity: 0,
        scale: context.conditions.isDesktop ? 0.985 : 1,
        duration: context.conditions.isDesktop ? 0.72 : 0.5,
        stagger: context.conditions.isDesktop ? 0.09 : 0.06,
        ease: 'power3.out',
      })
    })
