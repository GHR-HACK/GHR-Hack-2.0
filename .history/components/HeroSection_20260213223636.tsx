          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex justify-center mt-4">
              <Button
                variant="secondary"
                size="lg"
                className="min-w-[220px] font-red-hat-display bg-gradient-to-r from-primary-orange to-primary-purple text-white hover:shadow-xl hover:shadow-primary-purple/40 hover:-translate-y-1"
