          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
            {hackathonThemes.map((theme, index) => {
              ...
              >
                ...
                {/* Purple Curved Shape in Bottom Right - Larger decorative element */}
                <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#5c0f8b] rounded-tl-full opacity-15"></div>

                {/* Content - Centered vertically and horizontally */}
                <div className="relative z-10 text-center flex flex-col items-center justify-center min-h-[93px]">
                  <h4 
                    className="text-[14.4px] font-normal text-[#6d6f70] leading-[21.6px] mb-4 px-2"
                    style={{
                  ...
                  {/* Purple Button */}
                  <button className="bg-[#5c0f8b] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#680b7d] transition-colors duration-300 shadow-sm">
                    Click Here
                  </button>
                </div>
              </div>
