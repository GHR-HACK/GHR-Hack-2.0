        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-0">
          ...
          <div className="contact-grid space-y-8">
            ...
            <Card variant="elevated" className="contact-card p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 font-red-hat-display mb-6">
            ...
            <Card variant="glass" className="contact-card p-8">
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-red-hat-display font-medium">Email</p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-red-hat-display font-medium">Phone</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="text-gray-800 font-red-hat-display font-medium">Address</p>
          ...
          <Card variant="elevated" className="contact-form p-6 md:p-8 h-auto mb-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 w-full">
              <div>
                <label className="block text-gray-800 font-red-hat-display font-medium mb-2">
                  Full Name *
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:border-primary-purple transition-colors"
              ...
              <div>
                ...
                <div className="flex">
                  <span className="inline-flex items-center px-3 py-3 bg-gray-100 border border-r-0 border-gray-300 rounded-l-lg text-gray-800">
                    🇮🇳 +91
                  </span>
                  <input
                    type="tel"
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="mt-1 w-4 h-4 text-primary-purple bg-gray-50 border-gray-300 rounded focus:ring-primary-purple"
                />
                <label className="text-gray-600 font-red-hat-display text-sm">
