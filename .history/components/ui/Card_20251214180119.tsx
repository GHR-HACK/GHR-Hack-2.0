...
export default React.forwardRef<HTMLDivElement, CardProps>(function Card({
  ...
  return (
    <div ref={ref} onClick={onClick} className={classes}>
      {/* Decorative top-left orange curve */}
      <div className="absolute -top-6 -left-6 w-24 h-24 bg-gradient-to-br from-primary-orange to-primary-orange/80 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
      
      {/* Decorative bottom-right purple curve */}
      <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-gradient-to-tl from-primary-purple/10 to-transparent rounded-full opacity-100 pointer-events-none" />
