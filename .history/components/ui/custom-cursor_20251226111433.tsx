...
export default function SnakeCursor() {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Update head with snake-like movement (increased responsiveness)
      // - raised base lerp and multiplier to make head follow mouse faster
      const headLerp = 0.18 + Math.min(speed * 0.01, 0.18);
      ...
      for (let i = 1; i < SEGMENTS; i++) {
        // increase body follow speed for a snappier snake
        const lerpAmount = 0.28 * (1 - i / (SEGMENTS * 2));
