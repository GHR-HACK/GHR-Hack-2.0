...
export default React.forwardRef<HTMLDivElement, CardProps>(function Card({
  ...
  const baseClasses = 'relative rounded-xl transition-all duration-500 ease-in-out overflow-hidden';

  const variants = {
    default: 'bg-white border border-black/10 shadow-lg hover:shadow-2xl hover:shadow-black/20',
    glass: 'bg-white border border-black/10 shadow-lg backdrop-blur-sm hover:shadow-2xl hover:shadow-black/20',
    gradient: 'bg-white border border-black/10 shadow-lg hover:shadow-2xl hover:shadow-black/20',
    elevated: 'bg-white border border-black/15 shadow-xl hover:shadow-2xl hover:shadow-black/30',
  };
