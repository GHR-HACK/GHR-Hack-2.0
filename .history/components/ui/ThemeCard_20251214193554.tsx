...
export function ThemeCard({
  ...
  return (
    <div className="relative w-full max-w-[480px] mx-auto">
      ...
      <div
        ref={cardRef}
        className="relative bg-white rounded-[24px] shadow-[0_8px_30px_rgba(0,0,0,0.12)] overflow-hidden pt-16 pb-10 px-10 transition-all duration-300 cursor-pointer group"
      >
        {/* Content */}
