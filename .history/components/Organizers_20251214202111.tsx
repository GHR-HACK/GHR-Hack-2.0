            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {organizers.coordinators.map((coordinator, index) => (
                <Card
                  ...
                  variant="elevated"
                  hover
                  className="organizer-card group relative h-80"
                >
                  {coordinator.image ? (
                    <>
                      <Image
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent rounded-3xl flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <h4 className="text-lg font-red-hat-display font-bold text-white mb-2">
                          {coordinator.name}
                        </h4>
                    ...
                    <div className="p-6 text-center h-full flex flex-col items-center justify-center">
                      ...
                      <h4 className="text-lg font-red-hat-display font-bold text-black mb-2 group-hover:gradient-text transition-all duration-300">
                        {coordinator.name}
                      </h4>
                      <p className="text-primary-orange font-red-hat-display text-sm mb-3">
                        {coordinator.role}
