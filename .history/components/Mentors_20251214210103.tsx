...
export default function Mentors() {
  ...
  const renderProfileCard = (mentor: any, index: number = 0) => (
    <div
      key={index}
      className="mentor-card group relative h-96 max-w-sm rounded-3xl overflow-hidden shadow-2xl hover:shadow-2xl hover:shadow-black/40 transition-all duration-500 ease-in-out cursor-pointer hover:scale-[1.02] hover:translate-y-[-4px]"
    >
      {mentor.image ? (
        <>
          <img
      ...
      <Container>
        ...
        <div className="mentors-grid space-y-16">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center">
              {renderProfileCard(mentors.executiveDirector, 0)}
            </div>
          </div>
