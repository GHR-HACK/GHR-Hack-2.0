        ...
        {sponsorList.map((sponsor, index) => (
          ...
          >
            <div className="p-4 text-center">
              {sponsor.logo ? (
                <div className="w-24 h-20 mx-auto mb-3 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  <Image
                    src={sponsor.logo}
                    alt={sponsor.name}
                    width={96}
                ...
                <div className="w-20 h-20 mx-auto mb-3 bg-gradient-to-r from-primary-orange/20 to-primary-purple/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
