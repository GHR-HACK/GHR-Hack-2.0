...
export default function FAQs() {
  ...
  return (
    <section
      id="faq"
      ref={sectionRef}
      className="pt-12 pb-20 md:pt-16 md:py-32 bg-white"
    >
      <Container>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-red-hat-display font-bold text-gray-800 group-hover:gradient-text transition-all duration-300 pr-4">
                    {faq.question}
                  </h3>
                ...
                <div className="faq-answer overflow-hidden" style={{ height: 0, opacity: 0 }}>
                  <p className="text-gray-600 font-red-hat-display mt-4 pt-4 border-t border-gray-200">
