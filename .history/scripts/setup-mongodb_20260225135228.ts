...
async function setupMongoDB() {
  ...
  try {
    ...
    const samplePS = [
      ...
      {
        title: 'Intelligent Energy Optimization System for Shared Spaces Using IoT',
        description: 'Develop an IoT system that dynamically optimizes electricity consumption in shared environments such as classrooms, hostels, offices, or co-working spaces. The system should monitor occupancy, environmental conditions, and device usage to automatically control lighting, fans, and appliances.\nThe objective is not simple automation but adaptive energy intelligence that learns usage behavior patterns over time.',
        domain: 'IoT & Wearables',
        expected_outcomes: [
          'Occupancy-aware device automation',
          'Energy consumption analytics dashboard',
          'AI-assisted energy-saving recommendations',
          'Automatic device control based on real usage patterns',
          'Measurable reduction in power wastage',
        ],
        key_constraints: [
          'Must prioritize user comfort over aggressive energy saving',
          'Devices should continue functioning during network failure',
          'Low-cost hardware implementation required',
          'Data collection must respect privacy (no cameras required)',
        ],
        created_at: new Date(),
      },
    ];
